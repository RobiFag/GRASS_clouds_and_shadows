...
r.mapcalc --overwrite "rule_blue_max_swir12_3rd = ( $fb1 > $fb8 ) && ( $fb1 <  $fb4) && (  $fb1 < 0.1 ) && ( $fb8 < 0.1 )" ### true if shadows cover vegetation ### 

r.mapcalc --overwrite "rule_blue_min_swir12_3rd = ( $fb1 < $fb8 ) && ( $fb1 <  $fb4) && (  $fb1 < 0.1 ) && ( $fb8 < 0.1 ) && ($fb4 < 0.1 )" ### true if shadows cover bare soil ### 

r.mapcalc --overwrite "rule_blue_swir12_TOT = (rule_blue_max_swir12_3rd == 1) || (rule_blue_min_swir12_3rd == 1)" 
...
v.clean --overwrite input=shadow_def_3rd_v output=shadow_def_3rd_v_clean tool=rmarea threshold=10000
