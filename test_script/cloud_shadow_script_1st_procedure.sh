...
r.mapcalc --overwrite "rule_blue_max_swir12_1st = ( $fb1 > $fb8 ) && ( $fb1 <  $fb4) && (  $fb1 < 0.1 ) && ( $fb8 < 0.1 )" 

r.mask raster=rule_blue_max_swir12_1st maskcats=1

r.mapcalc --overwrite "diff_blu_green_1st = ($fb2 - $fb1)"

r.mapcalc --overwrite "shadow_def_1st = (rule_blue_max_swir12_1st == 1) && (diff_blu_green_1st < 0.007)"

r.null map=shadow_def_1st setnull=0 --overwrite

r.to.vect -s input=shadow_def_1st output=shadow_def_1st_v type=area --overwrite

v.clean --overwrite input=shadow_def_1st_v output=shadow_def_1st_v_clean tool=rmarea threshold=10000
